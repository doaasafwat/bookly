...
import 'package:bookly/Features/home/presention/views/widget/book_details_view_body.dart';
...
class _BookDetailsViewState extends State<BookDetailsView> {
  ...
  void initState() {
    BlocProvider.of<SimilarBooksCubit>(context)
        .fetchSimilerdBooks(category: widget.books.volumeInfo.categories![0]);
    super.initState();
  }
